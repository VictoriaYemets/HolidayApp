...
public class MyAdaprer extends RecyclerView.Adapter <MyAdaprer.MyViewHolder> {
    ...
    public interface ListItemClickListener {
        void mOnListItemClick(int clickedItemIndex);
    }
    ...
    public MyAdaprer (ListHolidaysInfo listHolidaysInfo, int length, ListItemClickListener listener) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            mOnClickListener.mOnListItemClick(position);
        }
    }
}
